    ...
    <div class="card">
        <div class="title mb-6">
            <p class="mb-4 text-4xl font-bold">
               Export Project (Laravel Source Code)
            </p>
            <p class="text-2xl text-gray-400 font-light">
               Export the app and start coding with a great headstart, the app will be exported base on your recorded configurations
            </p>
        </div>
